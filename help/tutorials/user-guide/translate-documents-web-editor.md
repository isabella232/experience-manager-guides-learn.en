...
description: Translate your content into multiple languages from the web editor. Create a translation project, add the translation rules, view version differences, and dismiss out-of-sync files in AEM Guides.
