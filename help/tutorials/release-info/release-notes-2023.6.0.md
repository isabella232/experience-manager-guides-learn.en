...
This release note covers the upgrade instructions, compatibility matrix, and issues fixed in version June 23 of Adobe Experience Manager Guides (later referred as *AEM Guides as a Cloud Service*).
