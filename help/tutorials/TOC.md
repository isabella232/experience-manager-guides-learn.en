    ...
    + On-prem/Managed Services {#on-prem-release-notes}
      + 4.2 Release {#42-release}
        + What's new {#42-whats-new}
          + [4.2 What's new](./release-info/release-notes-4.2.md)
...
+ Installation Guide {#install-guide}
  ...
  + Download and install {#download-install-aemg}
    ...
    + [Upgrade Adobe Experience Manager Guides](./install-guide/upgrade-xml-documentation.md)
    + [Uninstall AEM Guides](./install-guide/download-install-unistall-dxml.md)
