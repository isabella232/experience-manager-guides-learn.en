...
|  **Create PDF with change bar between two publication versions**  | Use the following options to create a PDF showing the differences in content between two baseline versions:   <br>* **Baseline of the previous version** Choose the baseline version which you want to compare with the current version. Changes bar is shown in the PDF to indicate the changes. <br> **Note**: If you select **Use baseline** and choose a baseline to publish, the comparison will be done between the two selected baseline versions. For example, if you choose baseline version 1.1 under **Use baseline**, and version 1.3 under **Baseline of the previous version**, the comparison will be done between baseline version 1.1 and baseline version 1.3. <br> * **Show modification as tracked changes** View the inserted text as highlighted and underlined. This option is selected by default. <br> * **Show deleted text** View the deleted text marked with a strikethrough. This option is selected by default.|
