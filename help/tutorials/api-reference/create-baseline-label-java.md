...
&sol;&comma;&colon;&comma;&lsqb;&comma;&rsqb;&comma;&verbar;&comma;&ast; <br> In case you want to set multiple labels, then separate labels with a comma; for example Label1, Label2.|
